...
void FlightController::mainLoop(float dt) {
  ...
  controlANGLE(dt); //Stabilize on angle setpoint
  //controlANGLE2(dt); //Stabilize on angle setpoint using cascaded method. Rate controller must be tuned well first!
  //controlRATE(dt); //Stabilize on rate setpoint
